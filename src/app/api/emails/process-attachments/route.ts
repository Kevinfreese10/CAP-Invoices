...
import { addDoc, collection, getFirestore, serverTimestamp, doc, setDoc } from 'firebase/firestore';
...
export async function POST(req: Request) {
  try {
    ...
    // 4. Mark the email as processed in Firestore to avoid re-processing
    if (processedCount > 0) {
