        ...
        <div className="space-y-4">
            ...
            <Menubar className="w-full bg-card">
                <MenubarMenu>
                    ...
                    <MenubarContent>
                        <MenubarItem asChild><Link href={`/dashboard/ai-accountant/${clientId}/dashboard`}>Dashboard</Link></MenubarItem>
                    </MenubarContent>
                </MenubarMenu>
                 <MenubarMenu>
                    ...
                    <MenubarContent>
                        ...
                        <MenubarItem asChild><Link href={`/dashboard/ai-accountant/${clientId}/bank/transactions`}>Bank Accounts</Link></MenubarItem>
                        <MenubarItem asChild><Link href={`/dashboard/ai-accountant/${clientId}/chart-of-accounts`}>Chart of Accounts</Link></MenubarItem>
                        <MenubarItem asChild><Link href={`/dashboard/ai-accountant/${clientId}/journals`}>Journals</Link></MenubarItem>
                    </MenubarContent>
                </MenubarMenu>
                <MenubarMenu>
