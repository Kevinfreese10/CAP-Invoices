...
export default function AIAccountantPage() {
    ...
    const fetchClients = async () => {
        ...
        try {
            ...
            setAllStaff(staffSnapshot.docs.map(doc => ({...doc.data(), id: doc.id} as User)));
        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                 <div>
                    ...
                    <p className="text-muted-foreground">Manage all clients using the AI Accountant module.</p>
                </div>
