    ...
    return (
        <div className="space-y-8">
             <div className="flex items-center justify-between">
                <div>
                     <h1 className="text-3xl font-bold tracking-tight">AI Accountant Settings</h1>
                     <p className="text-muted-foreground">Manage the master data for the AI Accountant module.</p>
                </div>
                ...
                <TabsContent value="chart-of-accounts">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                This is the default chart of accounts used for all new AI Accountant client profiles.
                            </CardDescription>
                            <Input
                        ...
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <CardDescription>
                                        These are the default rules applied to all new AI Accountant clients for automatic transaction allocation.
                                    </CardDescription>
                                </div>
